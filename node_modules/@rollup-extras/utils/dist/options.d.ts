import { DefaultsFactory, SimpleOptions } from './types';
...
export declare function getOptionsObject<T extends {
    [key: string]: unknown;
}, D, F extends DefaultsFactory<T>>(options: T, defaults?: D, factory?: F): T & { [key in keyof F]: F[key] extends (options: Partial<T>, field: string) => unknown ? ReturnType<F[key]> : unknown; } & D;
